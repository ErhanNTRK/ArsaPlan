...
export const FIELD_CROPS: CropRef[] = [
  ...
  { name: 'Sofralık Üzüm Bağı', yieldPerUnit: 2000, price: 35, expensePct: 45, years: 30, source: 'genel referans 2025-26', note: 'Fiyat kaynağa göre değişir: Gemini 60-74 TL, çevrimiçi satıcı hal fiyatı 50 TL, hasat/bölge/çeşide göre 4-63 TL arası geniş aralık görülüyor' },
  { name: 'Şaraplık Üzüm Bağı', yieldPerUnit: 1500, price: 25, expensePct: 45, years: 30, source: 'genel referans 2025-26', note: 'Güncel, tek bir doğrulanmış TL/kg alım fiyatı bulunamadı; temkinli kullanın' },
  { name: 'Kurutmalık Üzüm Bağı', yieldPerUnit: 1800, price: 45, expensePct: 45, years: 30, source: 'genel referans 2025-26', note: 'DİKKAT: kg başına verim/fiyat eşleşmesi netleşmedi — TMO destekli kuru üzüm 12-14 TL/kg iken serbest piyasa 70-100 TL/kg; ayrıca ~4 kg yaş üzüm 1 kg kuruya karşılık gelir. Elle kontrol edin.' },
