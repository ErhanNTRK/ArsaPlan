...
export const APP_NAME = 'ArsaPlan';
const VERSION = 'v2.0.0 · 2026.07.21';
const DRAFT_KEY = 'arsaplan-taslak-v1';
...
const STEPS = [
  ...
  { title: 'İmar Durumu', desc: 'Yapılaşma hakları, çekme mesafeleri ve emsal istisnaları.' },
  { title: 'Proje', desc: 'Kapasite, konut tipi ve villa kurgusu.' },
    ...
    <div className="app">
      <div className="topbar">
        <div className="topbar-inner">
          <div>
            <h1>{APP_NAME}</h1>
            <p>Arsa Değer Analizi · Proje Geliştirme (Artık Değer Yöntemi)</p>
          </div>
        </div>
      ...
      <div className="step" key={step}>
        ...
        {!isResult && <div className="stamp">{APP_NAME} · {VERSION}</div>}
      </div>
